...
const resources: Array<Resource> = [
    {
        href:        "/server-cli",
        name:        "Server CLI",
        description: "Learn about the server CLI and how to start, stop, and manage the server.",
...
function Resource({ resource }: {
    ...
    return (
        ...
        >
            <ResourcePattern { ...resource.pattern } mouseX={ mouseX }
                             mouseY={ mouseY }
            />
            <div
