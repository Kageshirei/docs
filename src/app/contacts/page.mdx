...
<Row>
    <Col>
        ...
        This endpoint allows you to retrieve a paginated list of all your contacts. By default, a maximum of ten
...
<Row>
    <Col>
        ...
        This endpoint allows you to add a new contact to your contact list in Protocol. To add a contact, you must
        provide their Protocol username and phone number.
...
<Row>
    <Col>
        ...
        This endpoint allows you to retrieve a contact by providing their Protocol id. Refer to [the
        list](#the-contact-model) at the top of this page to see which properties are included with contact objects.
...
<Row>
    <Col>
        ...
        This endpoint allows you to delete contacts from your contact list in Protocol. Note: This will also delete your
        conversation with the given contact.
