...
<Row>
    <Col>
        ...
        This endpoint allows you to retrieve a paginated list of all your attachments (in a conversation if a
        conversation id is provided). By default, a maximum of ten attachments are shown per page.
...
<Row>
    <Col>
        ...
        This endpoint allows you to upload a new attachment to a conversation. See the code examples for how to send the
        file to the Protocol API.
...
<Row>
    <Col>
        ...
        This endpoint allows you to retrieve an attachment by providing the attachment id. Refer to [the
        list](#the-attachment-model) at the top of this page to see which properties are included with attachment
        objects.
...
<Row>
    <Col>
        ...
        This endpoint allows you to perform an update on an attachment. Currently, the only supported type of update is
